...
public:
    ...
    std::vector<int> getMostLikelyCombination() const {return m_mostLikelyCombination;}  // 新增：获取最有可能的组合
    ...
    void calculateMostLikelyCombination();  // 新增：计算最有可能的工件组合
...
private:
    ...
    std::vector<int> m_mostLikelyCombination;                                // 新增：最有可能的工件组合
};
