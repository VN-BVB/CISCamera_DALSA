...
public:
    ...
    // -------------------- 迭代去畸变 --------------------
    Eigen::MatrixXd undistortPointsIter(const Eigen::MatrixXd& points_px, const Eigen::Matrix3d& K,
                                        const Eigen::Matrix<double, 1, 5>& coff_dis, int max_iter = 200, double tol = 1e-9);
