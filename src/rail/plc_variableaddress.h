...
constexpr int X_PosLimitSignal = 20029;        // OUT_正极限位信号 (S0)
constexpr int X_PosLimitAlarm = 0xE001;        // OUT_正限位报警 (S1)
constexpr int X_NegLimitSignal = 20030;        // OUT_负极限位信号 (S2)
...
constexpr int X_RelativePosHolding = 61;       // OUT_相对定位完成保持 (S13)
...
constexpr int Y_EnableComplete = 20000;        // OUT_使能完成 (S37)
