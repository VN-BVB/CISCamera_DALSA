...
# ---------- Python 环境 ----------
PYTHON_VER = 39
PYTHON_ROOT = E:/apps/Anaconda/envs/Telecentric-Calibration #同样要设置环境变量
INCLUDEPATH += $$PYTHON_ROOT/include
LIBS += -L$$PYTHON_ROOT/libs -lpython$$PYTHON_VER
INCLUDEPATH += $$PWD/extern/pybind11/include
# ------------------tinyspline库------------------
...
# ------------------dxflib库------------------
INCLUDEPATH += $$PWD/dxflib-3.26.4-src
SOURCES += \
    $$PWD/dxflib-3.26.4-src/dl_dxf.cpp \
    $$PWD/dxflib-3.26.4-src/dl_writer_ascii.cpp
